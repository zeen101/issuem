...
?>
			...
			<div class="wrap issuem-settings">
				...
				<div class="postbox-container column-primary">
					...
					<?php if (in_array($current_tab, $settings_tabs)) {
					?>
														...
														<tr>
															...
															<td>
																...
																<?php if (0 < $settings['custom_image_used']) { ?>
																	<p><a href="?<?php echo http_build_query(wp_parse_args(array('remove_default_issue_image' => 1), $_GET));
																					__('Remove Custom Default Issue Image', 'issuem'); ?>"></a></p>
																<?php } ?>
															</td>
														</tr>

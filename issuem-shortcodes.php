...
if (!function_exists('do_issuem_archives')) {
	...
	function do_issuem_archives($atts)
	{
		...
		<div class="issuem_archives_shortcode">
			...
			<?php foreach ($archives as $archive => $issue_array) {
			...
			?>
				...
				<div id="issue-<?php echo $issue_array[0]->term_id; ?>" class="issuem_archive <?php echo $class; ?>">
					...
					$width = apply_filters('issuem-cover-image-width', $issuem_settings['cover_image_width']);
					$height = apply_filters('issuem-cover-image-height', $issuem_settings['cover_image_height']);
